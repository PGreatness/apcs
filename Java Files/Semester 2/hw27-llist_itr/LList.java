...
{ 
  ...
  class MyIterator implements Iterator<T> 
  {
    ...
    public void remove() 
    {
      ...
      // Probably just these 3
      //      
	    //if ________...
	    else {
        DLLNode<T> tmp = _dummy;
        _dummy = _dummy.getNext();
        _dummy.setPrev(tmp.getPrev());
        tmp.getPrev().setNext(_dummy);
        tmp.setPrev(null);
        tmp.setNext(null);
	    }
