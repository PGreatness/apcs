/**
   ...
   (RunMed provides for calculating a running median
    ...
    -------------------------
    Team QueuedUp (Roster: Ahnaf Hasan, Ying Xin Jiang, Kevin Wang)
    APCS2
    2018-05-17
*/
...
public class RunMedDriver
{
  ...
  public static void main( String[] args )
  {
    ...
    //long startTime = System.currentTimeMillis();   //just got curious
    ...
    //System.out.println("\nThis took: " + (System.currentTimeMillis() - startTime) + " milliseconds to complete");
