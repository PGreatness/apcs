...
public class Pig {
    ...
    */
    ...
    public static boolean haveCap(String W) {//does it have a capital letter?
    ...
    /*String translate(String w)-- the culmination of everything!!!(still glitchy
- we're using the rule that capital letters are preserved in their original positions
     */
	...
	if (cap) {//if there is capital letter in our string???
	    ...
	    return fin;//return the modified string
	}
	else {
	    return ret;
	}
	...
	System.out.println(storeCapital("waSn't"));//2
	System.out.println(storeCapital("June"));//0
